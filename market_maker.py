# Sample of market maker for cryptocurrency market by B.J.
...
def run():
    print("test")
    logger.info('BitMEX Market Maker Version test: %s\n' % constants.VERSION)

    om = OrderManager()    # Try/except just keeps ctrl-c from printing an ugly stacktrace
    try:
        om.init()
        om.run_loop()
